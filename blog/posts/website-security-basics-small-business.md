---
title: Bots Are Scanning Your Website Right Now. Here's What They Want.
...
- **Exposed secrets.** API keys, passwords, and config files accidentally left where the public can reach them. It is the digital version of taping your house key to the front door.
- **Out-of-date software.** An old version of your site platform, a plugin nobody has updated in two years, a theme with a known hole. Bots keep a list of every known weakness and simply try them all.
- **Weak or default logins.** admin / admin still works more often than you would believe.
- **Missing basic protections.** No HTTPS, no security headers, forms that send data in the clear.
...
*Want to know where your site stands? [Grab a free website check from CTF Designs](https://ctfdesigns.com/audit) and we'll tell you what we find.*
